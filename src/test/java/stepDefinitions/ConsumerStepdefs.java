...
public class ConsumerStepdefs {
    ...
    @Then("^I select the consumer facility \"(.*?)\"$")
    public void selectFacility(String facilityName) throws Throwable {
        ...
        if (recordElt == null) {
            Thread.sleep(3000);
            WebElement facility = SeleniumFunctions.findElement(Hooks.getDriver(), By.xpath("//img[@class='imgMeetingRoom' and parent::div[@class='facilityThumbnail' and following-sibling::div[(@class='secondChildDivision' or @class='facilityDetailsContainer') and descendant::*[contains(normalize-space(.),'" + facilityName + "')]]]]"));
//            WebElement facility = SeleniumFunctions.findElement(Hooks.getDriver(),By.xpath("//img[@class='imgMeetingRoom' and parent::div[@class='facilityThumbnail' and following-sibling::div[@class='facilityDetailsContainer' and descendant::*[contains(normalize-space(.), 'JNR Co-working')]]]]"));
            SeleniumFunctions.explicitWait(Hooks.getDriver(), 10, "//img[@class='imgMeetingRoom' and parent::div[@class='facilityThumbnail' and following-sibling::div[(@class='secondChildDivision' or @class='facilityDetailsContainer') and descendant::*[contains(normalize-space(.),'" + facilityName + "')]]]]" + ";" + "xpath");
            facility.click();
        } else {
